...

{
  ...
  do {
    printf("%p, %p \n",auth,service);
    pcVar2 = fgets((char *)local_90,0x80,stdin); // 0x80 = 128
    bVar7 = false;
    bVar9 = pcVar2 == (char *)0x0; // 0x0 = 0
    if (bVar9) {
      return 0;
    }
    iVar3 = 5;
    ...
    if (bVar7) {
      ...
      *auth = 0;
      uVar4 = 0xffffffff; // 0xffffffff = 4294967295U
      pcVar2 = local_8b;
      do {
        if (uVar4 == 0) break;
        uVar4 = uVar4 - 1;
      ...
      uVar4 = ~uVar4 - 1;
      bVar8 = uVar4 < 0x1e; // 0x1e = 30
      bVar7 = uVar4 == 0x1e; // 0x1e = 30
      if (uVar4 < 0x1f) { // 0x1f = 31
    ...
    if (bVar7) {
      ...
      bVar7 = acStack137 == (char *)0x0; // 0x0 = 0
